...
exports.SynapseFingerprintError = exports.SynapseFrozenError = exports.SynapseValidationError = exports.SynapseNotFoundError = exports.SynapseAuthError = exports.SynapseError = void 0;
exports.throwSynapseError = throwSynapseError;
/**
 ...
 */
class SynapseAuthError extends SynapseError {
...
exports.SynapseAuthError = SynapseAuthError;
/**
 ...
 */
class SynapseNotFoundError extends SynapseError {
...
exports.SynapseNotFoundError = SynapseNotFoundError;
/**
 ...
 * ```
 */
class SynapseValidationError extends SynapseError {
...
exports.SynapseValidationError = SynapseValidationError;
/**
 * Thrown when the workspace is frozen and a write is attempted (HTTP 403).
 *
 * Server code: `WORKSPACE_FROZEN`
 */
class SynapseFrozenError extends SynapseError {
    constructor(message) {
...
exports.SynapseFrozenError = SynapseFrozenError;
/**
 ...
 */
class SynapseFingerprintError extends SynapseError {
    constructor(message) {
...
exports.SynapseFingerprintError = SynapseFingerprintError;
/**
 ...
 * @internal
 */
function throwSynapseError(status, body) {
