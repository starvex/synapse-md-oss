            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-1">
                  <span className="font-medium text-foreground truncate">{entry.agentId}</span>
                  <span className="text-muted text-sm">{formatRelativeTime(entry.timestamp)}</span>
                </div>
                <div className="text-muted text-sm line-clamp-2 break-words">
                  {entry.content.split('\n')[0]}
                </div>
              </div>
